...
<?php
    ...
    if(isset($_POST['Usr-login']))
    {
      ...
      $u_pwd=($_POST['u_pwd']);//
	  $ql2 = "select * from tms_user where u_email = '$u_email' and u_pwd = '$u_pwd'";
	  //echo $ql2;
		//insert into userLog(u_id, u_email, u_ip, u_city, u_country) values('$uid','$uemail','$ip','$city','$country')"; 
		$que_ql2 = mysqli_query($mysqli, $ql2);
		$u_id = ''; $cnt=0;
		while($row_que2 = mysqli_fetch_array($que_ql2)){
		$u_id = $row_que2['u_id']; $cnt++;
		...
		//echo $qry1; 
		$que_ql23 = mysqli_query($mysqli, $qry1);
